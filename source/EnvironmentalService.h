...
public:
    ...
    {
        humidity = (HumidityType_t) (newHumidityVal*100 );//0.01％単位
    ...
    {
        pressure = (PressureType_t) (newPressureVal*10 );//0.1パスカル単位　1気圧=1013hPa=101,300Pa　int32_tで-2,147,483.647hPa〜2,147,683.648hPaの範囲を
    ...
    {
        temperature = (TemperatureType_t) (newTemperatureVal * 100);//0.01°C単位のデータを100倍　int16_tで-327.67〜327.68°Cを
